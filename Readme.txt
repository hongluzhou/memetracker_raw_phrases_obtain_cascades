...
2. use the for loop to read the raw file one by one is slow, could directly load the lines.pickle and comment out that part. 

'lines.pickle' download address: 
)